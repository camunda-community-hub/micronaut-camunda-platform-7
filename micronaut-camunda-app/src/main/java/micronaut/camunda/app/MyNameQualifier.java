 ...
 */
@Internal
class MyNameQualifier<T> implements Qualifier<T>, io.micronaut.core.naming.Named {
    ...
    public boolean equals(Object o) {
        ...
        if (o == null || !MyNameQualifier.class.isAssignableFrom(o.getClass())) {
            return false;
        }

        MyNameQualifier<?> that = (MyNameQualifier<?>) o;
